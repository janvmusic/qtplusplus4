...
static const char qt_meta_stringdata_WaterCooler[] = {
    "WaterCooler\0"
};
...
const QMetaObjectExtraData WaterCooler::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WaterCooler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WaterCooler,
      qt_meta_data_WaterCooler, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WaterCooler::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WaterCooler))
